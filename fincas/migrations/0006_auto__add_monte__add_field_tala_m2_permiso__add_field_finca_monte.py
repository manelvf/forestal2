...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tala.m2_permiso'
        db.add_column('fincas_tala', 'm2_permiso', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Finca.monte'
        db.add_column('fincas_finca', 'monte', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fincas.Monte'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Tala.m2_permiso'
        db.delete_column('fincas_tala', 'm2_permiso')

        # Deleting field 'Finca.monte'
        db.delete_column('fincas_finca', 'monte_id')
    ...
    models = {
        ...
        'fincas.tala': {
            ...
            'empresas': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['empresas.Empresa']", 'symmetrical': 'False'}),
