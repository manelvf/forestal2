...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Concello.provincia'
        db.add_column('fincas_concello', 'provincia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fincas.Provincia'], null=True, blank=True), keep_default=False)

        # Adding field 'Provincia.code'
        db.add_column('fincas_provincia', 'code', self.gf('django.db.models.fields.CharField')(default='', max_length=5, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Concello.provincia'
        db.delete_column('fincas_concello', 'provincia_id')

        # Deleting field 'Provincia.code'
        db.delete_column('fincas_provincia', 'code')
