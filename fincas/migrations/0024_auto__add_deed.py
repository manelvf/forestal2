...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Deed'
        db.create_table('fincas_deed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
            ('buyer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.Empresa'])),
        ))
        db.send_create_signal('fincas', ['Deed'])


    def backwards(self, orm):
        # Deleting model 'Deed'
        db.delete_table('fincas_deed')
