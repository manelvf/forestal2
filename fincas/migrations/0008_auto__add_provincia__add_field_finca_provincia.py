...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fincas_provincia', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('fincas', ['Provincia'])

        # Adding field 'Finca.provincia'
        db.add_column('fincas_finca', 'provincia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fincas.Provincia'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Provincia'
        db.delete_table('fincas_provincia')

        # Deleting field 'Finca.provincia'
        db.delete_column('fincas_finca', 'provincia_id')
