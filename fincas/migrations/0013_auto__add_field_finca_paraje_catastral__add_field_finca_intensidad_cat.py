...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Finca.paraje_catastral'
        db.add_column('fincas_finca', 'paraje_catastral', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Finca.intensidad_catastral'
        db.add_column('fincas_finca', 'intensidad_catastral', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Finca.calificacion_catastral'
        db.add_column('fincas_finca', 'calificacion_catastral', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Finca.paraje_catastral'
        db.delete_column('fincas_finca', 'paraje_catastral')

        # Deleting field 'Finca.intensidad_catastral'
        db.delete_column('fincas_finca', 'intensidad_catastral')

        # Deleting field 'Finca.calificacion_catastral'
        db.delete_column('fincas_finca', 'calificacion_catastral')
