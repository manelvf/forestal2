...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ViaxeCamion.tm'
        db.alter_column('fincas_viaxecamion', 'tm', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'ViaxeCamion.metrocubico'
        db.alter_column('fincas_viaxecamion', 'metrocubico', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'ViaxeCamion.camion'
        db.alter_column('fincas_viaxecamion', 'camion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.Camion'], null=True))

        # Changing field 'ViaxeCamion.destino'
        db.alter_column('fincas_viaxecamion', 'destino_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.Empresa'], null=True))

        # Changing field 'ViaxeCamion.estereo'
        db.alter_column('fincas_viaxecamion', 'estereo', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'ViaxeCamion.dia'
        db.alter_column('fincas_viaxecamion', 'dia', self.gf('django.db.models.fields.DateField')(null=True))

        # Adding unique constraint on 'Finca', fields ['zona', 'parcela', 'poligon', 'concello']
        db.create_unique('fincas_finca', ['zona', 'parcela', 'poligon', 'concello_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Finca', fields ['zona', 'parcela', 'poligon', 'concello']
        db.delete_unique('fincas_finca', ['zona', 'parcela', 'poligon', 'concello_id'])

        # User chose to not deal with backwards NULL issues for 'ViaxeCamion.tm'
        raise RuntimeError("Cannot reverse this migration. 'ViaxeCamion.tm' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ViaxeCamion.metrocubico'
        raise RuntimeError("Cannot reverse this migration. 'ViaxeCamion.metrocubico' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ViaxeCamion.camion'
        raise RuntimeError("Cannot reverse this migration. 'ViaxeCamion.camion' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ViaxeCamion.destino'
        raise RuntimeError("Cannot reverse this migration. 'ViaxeCamion.destino' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ViaxeCamion.estereo'
        raise RuntimeError("Cannot reverse this migration. 'ViaxeCamion.estereo' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ViaxeCamion.dia'
        raise RuntimeError("Cannot reverse this migration. 'ViaxeCamion.dia' and its values cannot be restored.")
    ...
    models = {
        ...
        'fincas.viaxecamion': {
            ...
            'estereo': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metrocubico': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            ...
            'tm': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'})
        }
    }
