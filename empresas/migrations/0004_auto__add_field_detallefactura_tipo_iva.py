...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DetalleFactura.tipo_iva'
        db.add_column('empresas_detallefactura', 'tipo_iva', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.TipoIva'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DetalleFactura.tipo_iva'
        db.delete_column('empresas_detallefactura', 'tipo_iva_id')
