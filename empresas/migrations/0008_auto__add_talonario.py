...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Talonario'
        db.create_table('empresas_talonario', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recepcion', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('inicio', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('fin', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('PECL', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('destino', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.Empresa'], null=True)),
        ))
        db.send_create_signal('empresas', ['Talonario'])


    def backwards(self, orm):
        
        # Deleting model 'Talonario'
        db.delete_table('empresas_talonario')
