...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BorderFinca'
        db.create_table('fincas_borderfinca', (
            ...
            ('ref_catastral', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('obs', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('fincas', ['BorderFinca'])

        # Adding model 'Border'
        db.create_table('fincas_border', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('borderFinca', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fincas.BorderFinca'])),
        ...
        db.send_create_signal('fincas', ['Border'])


    def backwards(self, orm):
        # Deleting model 'BorderFinca'
        db.delete_table('fincas_borderfinca')

        # Deleting model 'Border'
        db.delete_table('fincas_border')
