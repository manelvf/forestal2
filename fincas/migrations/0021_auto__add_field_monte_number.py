...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Monte.number'
        db.add_column('fincas_monte', 'number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Monte.number'
        db.delete_column('fincas_monte', 'number')
