...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Finca.denom_catastral'
        db.add_column('fincas_finca', 'denom_catastral', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Finca.cultivo_catastral'
        db.add_column('fincas_finca', 'cultivo_catastral', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Finca.denom_catastral'
        db.delete_column('fincas_finca', 'denom_catastral')

        # Deleting field 'Finca.cultivo_catastral'
        db.delete_column('fincas_finca', 'cultivo_catastral')
