...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeedSellers'
        db.create_table('fincas_deedsellers', (
        ...
        db.send_create_signal('fincas', ['DeedSellers'])

        # Adding field 'Deed.deedType'
        db.add_column('fincas_deed', 'deedType',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DeedSellers'
        db.delete_table('fincas_deedsellers')

        # Deleting field 'Deed.deedType'
        db.delete_column('fincas_deed', 'deedType')
