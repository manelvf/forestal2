...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DetalleFactura.servizo'
        db.add_column('empresas_detallefactura', 'servizo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fincas.Tala'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DetalleFactura.servizo'
        db.delete_column('empresas_detallefactura', 'servizo_id')
