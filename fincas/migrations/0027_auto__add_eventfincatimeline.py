...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventFincaTimeline'
        db.create_table('fincas_eventfincatimeline', (
        ...
        db.send_create_signal('fincas', ['EventFincaTimeline'])


    def backwards(self, orm):
        # Deleting model 'EventFincaTimeline'
        db.delete_table('fincas_eventfincatimeline')
