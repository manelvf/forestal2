...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tala.dataPECLsaida'
        db.add_column('fincas_tala', 'dataPECLsaida', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Tala.altura'
        db.add_column('fincas_tala', 'altura', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tala.dataPECLsaida'
        db.delete_column('fincas_tala', 'dataPECLsaida')

        # Deleting field 'Tala.altura'
        db.delete_column('fincas_tala', 'altura')
