...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TipoCorta'
        db.create_table('fincas_tipocorta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('fincas', ['TipoCorta'])

        # Adding field 'Tala.tipocorta'
        db.add_column('fincas_tala', 'tipocorta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fincas.TipoCorta'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'TipoCorta'
        db.delete_table('fincas_tipocorta')

        # Deleting field 'Tala.tipocorta'
        db.delete_column('fincas_tala', 'tipocorta_id')
