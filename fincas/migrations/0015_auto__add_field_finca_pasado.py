...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Finca.pasado'
        db.add_column('fincas_finca', 'pasado', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Finca.pasado'
        db.delete_column('fincas_finca', 'pasado')
