...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Finca.ref_catastral'
        db.add_column('fincas_finca', 'ref_catastral', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Finca.ref_catastral'
        db.delete_column('fincas_finca', 'ref_catastral')
