...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventFincaType'
        db.create_table('fincas_eventfincatype', (
        ...
        db.send_create_signal('fincas', ['EventFincaType'])

        # Adding model 'EventFincaLog'
        db.create_table('fincas_eventfincalog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('eventfinca', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fincas.EventFinca'])),
            ('finca', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fincas.Finca'])),
        ))
        db.send_create_signal('fincas', ['EventFincaLog'])

        # Adding model 'DeedFinca'
        db.create_table('fincas_deedfinca', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fincas.Deed'])),
            ('finca', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fincas.Finca'])),
        ))
        db.send_create_signal('fincas', ['DeedFinca'])

        # Adding model 'EventFinca'
        db.create_table('fincas_eventfinca', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('empresa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.Empresa'], blank=True)),
            ('obs', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('eventType', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fincas.EventFincaType'])),
        ))
        db.send_create_signal('fincas', ['EventFinca'])

        # Adding field 'Deed.obs'
        db.add_column('fincas_deed', 'obs',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'EventFincaType'
        db.delete_table('fincas_eventfincatype')

        # Deleting model 'EventFincaLog'
        db.delete_table('fincas_eventfincalog')

        # Deleting model 'DeedFinca'
        db.delete_table('fincas_deedfinca')

        # Deleting model 'EventFinca'
        db.delete_table('fincas_eventfinca')

        # Deleting field 'Deed.obs'
        db.delete_column('fincas_deed', 'obs')
    ...
    models = {
        ...
        'fincas.deed': {
            ...
            'buyer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['empresas.Empresa']"}),
            'date': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.IntegerField', [], {}),
            'obs': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'sellers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['fincas.Finca']", 'through': "orm['fincas.DeedFinca']", 'symmetrical': 'False'})
        },
        'fincas.deedfinca': {
