...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fincas_relationship', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_parcel', self.gf('django.db.models.fields.related.ForeignKey')(related_name='from_parcel', to=orm['fincas.Finca'])),
            ('to_parcel', self.gf('django.db.models.fields.related.ForeignKey')(related_name='to_parcel', to=orm['fincas.Finca'])),
            ('owner', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('fincas', ['Relationship'])


    def backwards(self, orm):
        # Deleting model 'Relationship'
        db.delete_table('fincas_relationship')
